...
import moduleForAcceptance from 'gpdb-view/tests/helpers/module-for-acceptance';
import {getMockPayload} from 'gpdb-view/tests/helpers/test-helper';
import Utils from  'gpdb-view/utils/utils';
...
test('visiting /', function (assert) {
  ...
  andThen(function () {
    ...
    assert.equal(find('img#gpdb-logo').length, 1);
