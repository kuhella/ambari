...
package org.apache.ambari.view.gpdb;
...
public class QueryResourceProvider implements ResourceProvider<QueryResource> {
     ...
     */
    private static final String USER_PROP = "gpdb.user.name";
    private static final String USER_DESC = "GPDB User Name";

    private static final String PASSWORD_PROP = "gpdb.user.password";
    private static final String PASSWORD_DESC = "GPDB User Password";

    private static final String HOSTNAME_PROP = "gpdb.master.host";
    private static final String HOSTNAME_DESC = "GPDB Master Host";

    private static final String HOSTPORT_PROP = "gpdb.master.port";
    private static final String HOSTPORT_DESC = "GPDB Master Port";
    ...
    /**
     * The datasource wrapper on top of connection pool used to connect to the GPDB Master.
     */
    private GPDBDataSource dataSource = new GPDBDataSource();
    ...
    public Set<QueryResource> getResources(ReadRequest request) throws
        ...
        try {
            ...
            LOG.debug("Retrieved {} queries from GPDB Master", resources.size());
    ...
    /**
     * Retrieves a set of current queries from the GPDB Master.
     *
