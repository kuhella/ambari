...
public class QueryResourceProviderTest extends EasyMockSupport {
    ...
    @Mock
    private GPDBDataSource dataSource;
    ...
    public void testGetResources_MissingUserName() throws Exception {
        ...
        thrown.expectMessage("GPDB User Name property is not specified for the view instance.");

        Map<String, String> props = prepareViewContextProperties();
        props.remove("gpdb.user.name");
    ...
    public void testGetResources_MissingUserPassword() throws Exception {
        thrown.expect(SystemException.class);
        thrown.expectMessage("GPDB User Password property is not specified for the view instance.");

        Map<String, String> props = prepareViewContextProperties();
        props.remove("gpdb.user.password");
        expect(viewContext.getProperties()).andReturn(props).anyTimes();
        replayAll();
    ...
    public void testGetResources_MissingHostName() throws Exception {
        thrown.expect(SystemException.class);
        thrown.expectMessage("GPDB Master Host property is not specified for the view instance.");

        Map<String, String> props = prepareViewContextProperties();
        props.remove("gpdb.master.host");
        expect(viewContext.getProperties()).andReturn(props).anyTimes();
        replayAll();
    ...
    public void testGetResources_MissingHostPort() throws Exception {
        thrown.expect(SystemException.class);
        thrown.expectMessage("GPDB Master Port property is not specified for the view instance.");

        Map<String, String> props = prepareViewContextProperties();
        props.remove("gpdb.master.port");
        expect(viewContext.getProperties()).andReturn(props).anyTimes();
        replayAll();
    ...
    private Map<String, String> prepareViewContextProperties() {
        ...
        props.put("gpdb.user.name", "gpadmin-user");
        props.put("gpdb.user.password", "gpadmin-password");
        props.put("gpdb.master.host", "host1");
        props.put("gpdb.master.port", "1234");
        return props;
    }
}
