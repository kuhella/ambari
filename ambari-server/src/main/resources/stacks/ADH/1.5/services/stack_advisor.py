...
class ADH16StackAdvisor(ADH15StackAdvisor):
  def __init__(self):
      super(ADH16StackAdvisor, self).__init__()
      Logger.initialize_logger()

  def getServiceConfigurationRecommenderDict(self):
      parentRecommendConfDict = super(ADH16StackAdvisor, self).getServiceConfigurationRecommenderDict()
      childRecommendConfDict = {
  ...
  def recommendSTORMConfigurations(self, configurations, clusterData, services, hosts):
    ...
    STREAMLINE service.
    """
    super(ADH16StackAdvisor, self).recommendStormConfigurations(configurations, clusterData, services, hosts)
    storm_site = self.getServicesSiteProperties(services, "storm-site")
    storm_env = self.getServicesSiteProperties(services, "storm-env")
    putStormSiteProperty = self.putProperty(configurations, "storm-site", services)
    putStormSiteAttributes = self.putPropertyAttribute(configurations, "storm-site")
  ...
  def recommendSPARK2Configurations(self, configurations, clusterData, services, hosts):
    ...
    :type hosts dict
    """
    super(ADH16StackAdvisor, self).recommendSpark2Configurations(configurations, clusterData, services, hosts)
  ...
  def recommendZEPPELINConfigurations(self, configurations, clusterData, services, hosts):
    ...
    :type hosts dict
    """
    super(ADH16StackAdvisor, self).recommendZeppelinConfigurations(configurations, clusterData, services, hosts)
  ...
  def recommendYARNConfigurations(self, configurations, clusterData, services, hosts):
    super(ADH16StackAdvisor, self).recommendYARNConfigurations(configurations, clusterData, services, hosts)
    putYarnSiteProperty = self.putProperty(configurations, "yarn-site", services)
  ...
  def getServiceConfigurationValidators(self):
      parentValidators = super(ADH16StackAdvisor, self).getServiceConfigurationValidators()
      childValidators = {
  ...
  def recommendTezConfigurations(self, configurations, clusterData, services, hosts):
    super(ADH16StackAdvisor, self).recommendTezConfigurations(configurations, clusterData, services, hosts)
  ...
  def recommendRangerConfigurations(self, configurations, clusterData, services, hosts):
    super(ADH16StackAdvisor, self).recommendRangerConfigurations(configurations, clusterData, services, hosts)
  ...
  def recommendRangerKMSConfigurations(self, configurations, clusterData, services, hosts):
    super(ADH16StackAdvisor, self).recommendRangerKMSConfigurations(configurations, clusterData, services, hosts)
  ...
  def recommendHDFSConfigurations(self, configurations, clusterData, services, hosts):
    super(ADH16StackAdvisor, self).recommendHDFSConfigurations(configurations, clusterData, services, hosts)
    if 'hadoop-env' in services['configurations'] and 'hdfs_user' in  services['configurations']['hadoop-env']['properties']:
      hdfs_user = services['configurations']['hadoop-env']['properties']['hdfs_user']
    else:
      hdfs_user = 'hadoop'
  ...
  def recommendHBASEConfigurations(self, configurations, clusterData, services, hosts):
    super(ADH16StackAdvisor, self).recommendHBASEConfigurations(configurations, clusterData, services, hosts)
  ...
  def recommendKAFKAConfigurations(self, configurations, clusterData, services, hosts):
    super(ADH16StackAdvisor, self).recommendKAFKAConfigurations(configurations, clusterData, services, hosts)
