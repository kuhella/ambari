...
def hive_service_interactive(name, action='start', upgrade_type=None):
  ...
  ra.log('params.hive_server_interactive_conf_dir='+str(params.hive_server_interactive_conf_dir))
  ra.log('params.execute_path_hive_interactive'+str(params.execute_path_hive_interactive))
  if action == 'start':
    ...
    ra.log('params.execute_path'+str(params.execute_path))
    Execute(daemon_cmd,
