...
class ADH13StackAdvisor(ADH12StackAdvisor):
  ...
  def createComponentLayoutRecommendations(self, services, hosts):
    parentComponentLayoutRecommendations = super(ADH13StackAdvisor, self).createComponentLayoutRecommendations(services, hosts)
  ...
  def getNotPreferableOnServerComponents(self):
    parentComponents = super(ADH13StackAdvisor, self).getNotPreferableOnServerComponents()
    parentComponents.extend(['HAWQMASTER', 'HAWQSTANDBY'])
    return parentComponents

  def getComponentLayoutSchemes(self):
    parentSchemes = super(ADH13StackAdvisor, self).getComponentLayoutSchemes()
  ...
  def validateHDFSConfigurations(self, properties, recommendedDefaults, configurations, services, hosts):
    super(ADH13StackAdvisor, self).validateHDFSConfigurations(properties, recommendedDefaults, configurations, services, hosts)
