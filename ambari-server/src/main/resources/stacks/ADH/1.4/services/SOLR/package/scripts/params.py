...
solr_package_dir = '/usr/lib/solr/'
solr_config_dir = format('/usr/lib/solr/')
...
solr_webapp_dir = format('/usr/lib/solr/server/solr-webapp/webapp/')

# solr cloud
cloud_scripts = format('{solr_config_dir}/bin/')
