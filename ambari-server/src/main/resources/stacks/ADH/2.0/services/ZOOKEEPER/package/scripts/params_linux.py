...
if stack_version_formatted and check_stack_feature(StackFeature.ROLLING_UPGRADE, stack_version_formatted):
  zk_home = format("{stack_root}/{component_directory}")
  zk_bin = format("{stack_root}/{component_directory}/bin")
  zk_cli_shell = format("{stack_root}/{component_directory}/bin/zkCli.sh")
