...
nifi_install_dir = os.path.join(stack_root, "nifi-server")
...
nifi_toolkit_java_options = config['configurations']['nifi-toolkit-env']['nifi_toolkit_java_options'] if 'nifi-toolkit-env' in config['configurations'] else None
